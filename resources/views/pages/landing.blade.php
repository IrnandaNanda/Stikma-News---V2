@extends('layouts.app')
@section('title', 'Stikma News - Berita Stikma Terkini')
@section('content')
            ...
            @foreach ($featureds as $featured)
                <a href="{{ route('news.show', $featured->slug) }}">
                    <div class="border border-slate-200 p-3 rounded-xl hover:border-primary hover:cursor-pointer transition duration-300 ease-in-out"
                        ...
                        <img src="{{ route('featured.private', ['filename' => $featured->thumbnail]) }}" alt=""
                            class="w-full rounded-xl mb-3" style="height: 140px; object-fit: cover;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            <div
                ...
                <a href="{{ route('news.show', $news[0]->slug) }}">
                    ...
                    <img src="{{ route('news.private', ['filename' => $news[0]->thumbnail]) }}" alt="berita1"
                        class="rounded-2xl">
            ...
            @foreach ($news as $choice)
                <a href="{{ route('news.show', $choice->slug) }}">
                    <div
                        ...
                        <img src="{{ route('news.private', ['filename' => $choice->thumbnail]) }}" alt="" class="w-full rounded-xl mb-3" style="height: 200px; object-fit: cover;">
