...
@section('content')
    ...
    <div class="flex flex-col px-4 lg:px-14 mt-10">
        ...
        <div class="flex flex-col lg:flex-row w-full gap-10">
            <!-- Berita Utama -->
            <div class="lg:w-8/12">
                <img src="{{ route('news.private', ['filename' => $news->thumbnail]) }}" alt="MotoGP"
                            ...
                            <a href="{{ route('news.show', $new->slug) }}">
                                <div class="flex gap-3 border border-slate-300 hover:border-primary p-3 rounded-xl">
                                    ...
                                    <div class="flex gap-3 flex-col lg:flex-row">
                                        <img src="{{ route('news.private', ['filename' => $new->thumbnail]) }}"
                                            alt="" class="max-h-36 rounded-xl object-cover">
                                        <div class="">
    ...
    <div class="flex flex-col gap-4 mb-10 p-4 lg:p-10 lg:px-14 w-full lg:w-2/3">
        ...
        <a href="{{ route('author.show', $news->author->username) }}">
            <div
                ...
                <img src="{{ route('author.private', ['filename' => $news->author->avatar ?? '']) }}" alt="profile"
                    class="rounded-full w-24 lg:w-28 border-2 border-primary">
                <div class="text-center lg:text-left">
                    <p class="font-bold text-lg lg:text-xl">{{ $news->author->user->name ?? 'Unknown' }}</p>
